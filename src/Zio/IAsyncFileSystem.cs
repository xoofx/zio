...
namespace Zio
{
    ...
    public interface IAsyncFileSystem : IDisposable
    {
        ...
        ValueTask CreateDirectoryAsync(UPath path);
        ...
        ValueTask<bool> DirectoryExistsAsync(UPath path);
        ...
        ValueTask MoveDirectoryAsync(UPath srcPath, UPath destPath);
        ...
        ValueTask DeleteDirectoryAsync(UPath path, bool isRecursive);
        ...
        ValueTask CopyFileAsync(UPath srcPath, UPath destPath, bool overwrite);
        ...
        ValueTask ReplaceFileAsync(UPath srcPath, UPath destPath, UPath destBackupPath, bool ignoreMetadataErrors);
        ...
        ValueTask<long> GetFileLengthAsync(UPath path);
        ...
        ValueTask<bool> FileExistsAsync(UPath path);
        ...
        ValueTask MoveFileAsync(UPath srcPath, UPath destPath);

        /// <summary>
        /// Deletes the specified file. 
        /// </summary>
        /// <param name="path">The path of the file to be deleted.</param>
        ValueTask DeleteFileAsync(UPath path);
        ...
        ValueTask<Stream> OpenFileAsync(UPath path, FileMode mode, FileAccess access, FileShare share = FileShare.None);
        ...
        ValueTask<FileAttributes> GetAttributesAsync(UPath path);
        ...
        ValueTask SetAttributesAsync(UPath path, FileAttributes attributes);
        ...
        ValueTask<DateTime> GetCreationTimeAsync(UPath path);
        ...
        ValueTask SetCreationTimeAsync(UPath path, DateTime time);
        ...
        ValueTask<DateTime> GetLastAccessTimeAsync(UPath path);
        ...
        ValueTask SetLastAccessTimeAsync(UPath path, DateTime time);
        ...
        ValueTask<DateTime> GetLastWriteTimeAsync(UPath path);
        ...
        ValueTask SetLastWriteTimeAsync(UPath path, DateTime time);
        ...
        IAsyncEnumerable<UPath> EnumeratePathsAsync(UPath path, string searchPattern, SearchOption searchOption, SearchTarget searchTarget);
        ...
        IAsyncEnumerable<FileSystemItem> EnumerateItemsAsync(UPath path, SearchOption searchOption, SearchPredicate? searchPredicate = null);
        ...
        ValueTask<bool> CanWatchAsync(UPath path);
        ...
        ValueTask<IFileSystemWatcher> WatchAsync(UPath path);
        ...
        ValueTask<string> ConvertPathToInternalAsync(UPath path);

        /// <summary>
        /// Converts the specified system path to a <see cref="IAsyncFileSystem"/> path.
        /// </summary>
        /// <param name="systemPath">The system path.</param>
        /// <returns>The converted path according to the system path.</returns>
        ValueTask<UPath> ConvertPathFromInternalAsync(string systemPath);
    }
}
#endif