...
public abstract class TestFileSystemCompactBase : TestFileSystemBase
{
    ...
    public void TestFile()
    {
        ...
        if (IsWindows) AssertEx.AreNotEqual(fs.GetCreationTime("/toto.txt"), fs.GetCreationTime("/titi.txt"));
